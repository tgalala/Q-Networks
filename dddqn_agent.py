...
UPDATE_EVERY = 2      # Update frequency of the network
...
class dddqnAgent():
    ...
    def step(self, state, action, reward, next_state, done):
        # Save replay experience in memory (st,at,rt,st+1,done)  
        ...
        if self.t_step == 0:
            ...
            if len(self.memory) > BATCH_SIZE:
                ...
                self.learn_DDDQN(experiences, GAMMA)
    ...
    def learn(self, experiences, gamma):
        ...
        ***************************************************************
            experiences (Tuple of tensors): tuple of (s, a, r, s', done) 
    ...
    def learn_DDDQN(self, experiences, gamma):
        """
        ***************************************************************          
                   Updates parameters based on experience
        ***************************************************************
